                ...
                <ul class="list-group">
                    <li class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            Menu Data Barang
                            <a href="/admin/barang" class="btn btn-sm btn-dark"></i>Pilih >></a>
                        </div>
                    </li>
                    <li class="list-group-item">
                        <div class="d-flex justify-content-between align-items-center">
                            Menu Jenis Barang
                            <a href="/barang/jenis" class="btn btn-sm btn-dark">Pilih >></a>
                        </div>
                        </li>
                        <li class="list-group-item">
                            <div class="d-flex justify-content-between align-items-center">
                                Menu Jenis Dan Data Barang
                                <a href="/barang/barangdanjenis" class="btn btn-sm btn-dark">Pilih >></a>
                            </div>
                        </li>
                    </ul>
                    @endif
