            ...
            <div class="card-body">
                ...
                <form action="/barang/store" method="POST">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" id="kode_barang" value="{{ $tambahbarang }}"
                    ...
                    <button type="submit" class="btn btn-success btn-block mt-4"><i class="bi bi-plus-lg"></i> Tambah Data
                        Barang</button>
                    <a href="/admin/barang" class="btn btn-warning btn-block mt-4"><i class="bi bi-arrow-left-circle"></i>
                        Kembali</a>
                </form>
            </div>
        </div>
